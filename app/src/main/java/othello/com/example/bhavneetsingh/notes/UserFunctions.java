...
/*                 profilePic.setEnterTransition(new Slide());
    ...
    public void onClickPopupMenu(MenuItem menuItem, MyDatabase.User user) {
    ...
    public void onClickLikeButton(View context,int id, MyDatabase.User user) {
...
/*            ImageButton button = (ImageButton) (context.findViewById(id));
    ...
    //Shsre current post
    public void sharePost(View context, MyDatabase.User user)
    {
    ...
    public void onLikeClick(View context, final GifImageView button, final MyDatabase.User user) {
     if(user.isLiked())
     {
    ...
    public void onLongClickComment(MyDatabase.User user)
    {
