...
public class ProfileAdapter extends BaseAdapter {
    ...
    public ProfileAdapter(Context context, ArrayList<User>icons, FollowListener listener, User current)
    {
    ...
    public ProfileAdapter(Context context, ArrayList<User> users, FollowListener listener, User current, HashMap<String, Boolean> followers) {
        this.users = users;
        this.context = context;
        this.listener = listener;
        this.current = current;
