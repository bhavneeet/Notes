...
public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.UserHolder>{
    ...
    public interface OnClicks{
        void onClickPopupMenu(MenuItem menuItem, MyDatabase.User user);
        void onClickLikeButton(View context,int id,MyDatabase.User user);
        void onLongClickComment(MyDatabase.User User);
    }
    ...
    public UserListAdapter(Activity context, ArrayList<MyDatabase.User> users, UserListAdapter.OnClickIcon listener, UserListAdapter.OnClicks clicksListener)
    {
    ...
    public ArrayList<MyDatabase.User> getUsers() {
        return users;
    }
...
try{
    ...
    MyDatabase.User user =users.get(p);
    ...
    else
    {
        ...
        intent.putExtra(MyDatabase.User.USER_ID,userId);
        intent.putExtra(MyDatabase.User.NAME,user_name);
        intent.putExtra(MyDatabase.User.CATEGORY,"normal");
        context.startActivity(intent);
    }
}
catch (Exception e)
{
    Log.d("User",e.getLocalizedMessage());
        ...
        MyDatabase.User user=users.get(pos);
